...
class li {
  constructor(t) {
    T(this, "gestures", /* @__PURE__ */ new Set()), T(this, "_targetEventStore", new Bt(this)), T(this, "gestureEventStores", {}), T(this, "gestureTimeoutStores", {}), T(this, "handlers", {}), T(this, "config", {}), T(this, "pointerIds", /* @__PURE__ */ new Set()), T(this, "touchIds", /* @__PURE__ */ new Set()), T(this, "state", {
      shared: {
        shiftKey: !1,
        metaKey: !1,
        ctrlKey: !1,
...
function bi(i) {
  ...
  function ee(r, f, p, u) {
    let m = Z(r), L = _t(t[t.length - 1]), w = document.createElement("div"), A = document.createElement("div"), I = document.createElement("div"), _ = "";
    r.style.display = "block", w.id = "modal-close", w.classList.add("close-modal"), w.addEventListener(
      ...
      o();
    }, 300), x && x < window.innerHeight && window.innerWidth < s ? N(f, S) : dt(f, u), r.click(), r.style.overflow = "scroll", r.style.touchAction = "auto", setTimeout(() => {
      se(
        r,
        m,
        L,
      ...
      r,
      {
        onDrag: ({
          ...
          f = Z(u), window.innerWidth < s && (re[1] > 0 ? m && Ct === document.querySelector(`#${m}`) ? (u.style.overflow = "hidden", u.style.touchAction = "none", ht(
            ...
            mt,
            L
          ), x >= window.innerHeight && N(w, S, _), x >= window.innerHeight && z(L)) : u.scrollTop >= 1 && f <= v(100 - p) && (!m || Ct !== document.querySelector(`#${m}`)) ? (u.style.overflow = "scroll", u.style.touchAction = "auto", u.click()) : (u.style.overflow = "hidden", u.style.touchAction = "none", ht(
            u,
            kt,
            null,
            A,
            ...
            mt,
            L
          ), x >= window.innerHeight && N(w, S, _)) : Z(a) <= v(100 - p) ? (u.click(), u.style.overflow = "scroll", v(100 - p) > 0 && (u.style.minHeight = "unset"), u.style.height = `${v(p)}px`, u.style.touchAction = "auto") : (u.style.overflow = "hidden", u.style.touchAction = "none", ht(
            u,
            null,
            oe,
            A,
            ...
            mt,
            L
          ), x >= window.innerHeight && N(w, S, _)));
        },
        onDragStart: () => {
          document.body.style.overflow = "hidden", ft();
        },
        onDragEnd: ({ direction: A }) => {
          f = Z(u), (f <= v(100 - p) || x === 0) && A[1] < 0 && a.scrollTop >= 0 && (u.style.overflow = "scroll", u.click(), u.style.touchAction = "auto"), (f <= v(100 - p) || x === 0) && A[1] > 0 && a.scrollTop === 0 && (u.style.overflow = "hidden"), te();
        }
      },
      {
        drag: {
  ...
  function ht(r, f, p, u, m, L, w, A, I, _) {
    let E = w[1];
    if (p === null) {
      let H = function() {
        return It(
