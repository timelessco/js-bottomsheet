...
const H = {
  ...
  pointerCapture(i, t, {
    ...
    return this.pointerButtons = s, this.keys = n, !this.pointerLock && this.device === "pointer" && e;
  },
  threshold(i, t, {
    filterTaps: e = !1,
    tapsThreshold: s = 3,
...
function gi(i) {
  ...
  function N(h = !1, u = !0) {
    e && A && z(A), document.body.style.overflow = "scroll", h ? d === "modal" ? Et() : d === "sideSheetLeft" ? Tt() : mt() : $({
      ...
      easing: k,
      duration: 1
    }), T = v(120), T >= window.innerHeight && V && st(), z(A), o();
  }
  function St(h, u, a, g) {
  ...
  function nt() {
    document.body.style.overscrollBehavior = "contain", f && f(), R && !r ? (document.body.insertAdjacentHTML("beforeend", R), r = it ? document.querySelector(`#${it}`) : document.querySelector(
